...
const COUNTRY_INFO = {
  ...
  highlight: '千岛之国，热带海岛度假胜地',
  ctaCountry: 'PH',
  faqs: [
    { q: '菲律宾eSIM用哪个运营商网络？', a: '我们的菲律宾eSIM运行在Globe、Smart等主流网络上，覆盖马尼拉、宿务、长滩岛等热门区域。' },
    { q: '长滩岛信号怎么样？', a: '长滩岛主要旅游区信号良好，White Beach沿线4G覆盖完善，偏远小岛可能信号较弱。' },
    { q: '在马尼拉机场落地后能立即用吗？', a: '落地后开启eSIM数据即可使用，无需排队购卡。建议提前在国内扫码安装好eSIM。' },
...
export default function PhilippinesEsimPage({ products, minPrice }: PageProps) {
  const { t } = useI18n()
...
export const getStaticProps: GetStaticProps = async () => {
  const { local, regional } = getProductsByCountry('PH')
