...
const COUNTRY_INFO = {
  ...
  highlight: '巴厘岛天堂，万岛之国',
  ctaCountry: 'ID',
  faqs: [
    { q: '印度尼西亚eSIM用哪个运营商网络？', a: '我们的印尼eSIM运行在Telkomsel等主流网络上，覆盖巴厘岛、雅加达、日惹等热门区域。' },
    { q: '巴厘岛信号怎么样？', a: '巴厘岛库塔、水明漾、乌布等主要旅游区4G信号覆盖良好，偏远山区和小岛信号可能较弱。' },
    { q: '龙目岛能用印尼eSIM吗？', a: '龙目岛属于印度尼西亚，印尼eSIM可以使用，主要旅游区信号覆盖良好。' },
...
export default function IndonesiaEsimPage({ products, minPrice }: PageProps) {
  const { t } = useI18n()
...
export const getStaticProps: GetStaticProps = async () => {
  const { local, regional } = getProductsByCountry('ID')
