...
const COUNTRY_INFO = {
  ...
  nameEn: 'India',
  flag: '🇮🇳',
  carriers: 'Airtel / Jio / Vodafone IN',
  highlight: '文明古国，神秘东方之旅',
  ctaCountry: 'IN',
  faqs: [
    { q: '印度eSIM用哪个运营商网络？', a: '我们的印度eSIM运行在Airtel、Jio等主流网络上，覆盖德里、孟买、阿格拉、斋浦尔等热门城市。' },
    { q: '泰姬陵附近有信号吗？', a: '阿格拉泰姬陵景区内信号良好，主要城市旅游景点4G覆盖完善。' },
    { q: '印度对外国手机有限制吗？', a: '印度对境外手机使用有监管，建议确认您的设备支持印度网络频段（B1/B3/B5/B40/B41）。' },
...
export default function IndiaEsimPage({ products, minPrice }: PageProps) {
  const { t } = useI18n()
...
export const getStaticProps: GetStaticProps = async () => {
  const { local, regional } = getProductsByCountry('IN')
