...
const COUNTRY_INFO = {
  ...
  nameEn: 'Italy',
  flag: '🇮🇹',
  carriers: 'TIM / Vodafone IT / WindTre',
  highlight: '文艺复兴圣地，美食艺术之旅',
  ctaCountry: 'IT',
  faqs: [
    { q: '意大利eSIM用哪个运营商网络？', a: '我们的意大利eSIM运行在TIM、Vodafone等主流网络上，覆盖罗马、米兰、威尼斯、佛罗伦萨等热门城市。' },
    { q: '梵蒂冈城内有信号吗？', a: '梵蒂冈城面积很小，意大利运营商信号可以覆盖，参观圣彼得大教堂和广场期间可正常使用。' },
    { q: '意大利南部西西里岛信号怎么样？', a: '西西里主要城市信号良好，偏远山区信号可能较弱，建议提前下载好离线地图。' },
...
export default function ItalyEsimPage({ products, minPrice }: PageProps) {
  const { t } = useI18n()
...
export const getStaticProps: GetStaticProps = async () => {
  const { local, regional } = getProductsByCountry('IT')
