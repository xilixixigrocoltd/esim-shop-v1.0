...
const COUNTRY_INFO = {
  ...
  nameEn: 'Germany',
  flag: '🇩🇪',
  carriers: 'Deutsche Telekom / Vodafone',
  highlight: '工业强国，欧洲商务首选',
  ctaCountry: 'DE',
  faqs: [
    { q: '德国eSIM用哪个运营商网络？', a: '我们的德国eSIM运行在Deutsche Telekom、Vodafone等主流网络上，覆盖柏林、慕尼黑、法兰克福等主要城市。' },
    { q: '德国高铁上能用eSIM吗？', a: 'ICE高铁上有WiFi覆盖，eSIM在主要城市间信号良好，部分农村路段信号可能较弱。' },
    { q: '去纽伦堡看展会需要多少流量？', a: '商务展会建议选择5GB以上套餐，满足视频会议、邮件、实时通信等需求。' },
...
export default function GermanyEsimPage({ products, minPrice }: PageProps) {
  const { t } = useI18n()
