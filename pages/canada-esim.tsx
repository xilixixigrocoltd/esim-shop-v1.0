...
const COUNTRY_INFO = {
  ...
  highlight: '枫叶之国，北美自然奇观',
  ctaCountry: 'CA',
  faqs: [
    { q: '加拿大eSIM用哪个运营商网络？', a: '我们的加拿大eSIM运行在Rogers、Bell等主流网络上，覆盖多伦多、温哥华、蒙特利尔等主要城市。' },
    { q: '班夫国家公园有信号吗？', a: '班夫镇区信号良好，但公园内偏远山区和徒步路线信号较弱，建议提前下载离线地图。' },
    { q: '加拿大国土面积大，流量够用吗？', a: '城市间行驶高速公路信号通常良好，偏远地区（如育空、西北地区）信号覆盖有限。建议选择10GB以上套餐应对长途旅行。' },
...
export default function CanadaEsimPage({ products, minPrice }: PageProps) {
  const { t } = useI18n()
...
export const getStaticProps: GetStaticProps = async () => {
  const { local, regional } = getProductsByCountry('CA')
