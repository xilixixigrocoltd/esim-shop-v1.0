...
const COUNTRY_INFO = {
  ...
  highlight: '浪漫之都，欧洲必游目的地',
  ctaCountry: 'FR',
  faqs: [
    { q: '法国eSIM用哪个运营商网络？', a: '我们的法国eSIM运行在Orange、SFR等主流网络上，覆盖巴黎、里昂、马赛等城市及大部分旅游景点。' },
    { q: '在巴黎地铁里能用吗？', a: '巴黎地铁部分路段已覆盖4G网络，主要换乘站信号较好，地面区间信号覆盖完善。' },
    { q: '申根区其他国家能用法国eSIM吗？', a: '法国eSIM主要适用于法国境内，如需游览多个申根国，建议购买欧洲区域套餐。' },
...
export default function FranceEsimPage({ products, minPrice }: PageProps) {
  const { t } = useI18n()
...
export const getStaticProps: GetStaticProps = async () => {
  const { local, regional } = getProductsByCountry('FR')
