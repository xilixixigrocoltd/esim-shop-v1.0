...
const COUNTRY_INFO = {
  ...
  nameEn: 'Spain',
  flag: '🇪🇸',
  carriers: 'Movistar / Vodafone ES / Orange ES',
  highlight: '阳光海滩，热情弗拉门戈',
  ctaCountry: 'ES',
  faqs: [
    { q: '西班牙eSIM用哪个运营商网络？', a: '我们的西班牙eSIM运行在Movistar、Vodafone等主流网络上，覆盖马德里、巴塞罗那、塞维利亚等热门城市。' },
    { q: '巴塞罗那市内信号怎么样？', a: '巴塞罗那市区4G信号覆盖完善，包括圣家堂、巴塞罗那港等热门景点均有良好信号。' },
    { q: '去加那利群岛旅行能用吗？', a: '加那利群岛属于西班牙领土，西班牙eSIM可以正常使用，网络覆盖良好。' },
...
export default function SpainEsimPage({ products, minPrice }: PageProps) {
  const { t } = useI18n()
...
export const getStaticProps: GetStaticProps = async () => {
  const { local, regional } = getProductsByCountry('ES')
